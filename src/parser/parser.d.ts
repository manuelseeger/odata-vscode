...
export type StartRuleNames = "root";
export interface ParseOptions<T extends StartRuleNames = "root"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"root">>(
  input: string,
  options?: Options,
): any;
