import { TypeConverterConfig } from "./stubs";
import { AxiosRequestConfig } from "./stubs";
...
export interface ConfigFileOptions
    extends Omit<CliOptions, "sourceUrl" | "source" | "output" | "services"> {
    /**
     * Configuration options of the request to retrieve the metadata.
...
export interface ServiceGenerationOptions
     ...
     */
    byTypeAndName?: Array<
        ComplexTypeGenerationOptions | EntityTypeGenerationOptions | GenericTypeGenerationOptions
    >;
}
...
export interface RunOptions
    extends Required<
            Omit<
                ...
                "serviceName" | "sourceUrl" | "sourceUrlConfig" | "refreshFile"
            >
        >,
        Pick<
            ServiceGenerationOptions,
